...
public class OrderPreparedHandler : IIntegrationEventHandler<OrderPreparedEvent>
{
    ...
    public OrderPreparedHandler(IOrderSagaStatesRepository orderSagaStatesRepository, IOutboxRepository outboxRepository, IOrdersRepository ordersRepository, IUnitOfWork unitOfWork)
    {
