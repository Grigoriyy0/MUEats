...
{
    private OptionsGroup(string name, string? description)
    {
        Id = Guid.NewGuid();
        Name = name;
    ...
    public static Result<OptionsGroup, Error> Create(string name, string? description)
    {
        return new OptionsGroup(name, description);
    }
